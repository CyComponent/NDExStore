(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CyComponent"] = factory(require("React"), require("Redux"));
	else
		root["CyComponent"] = factory(root["React"], root["Redux"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_10__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cyComponent = __webpack_require__(17);

	var _cyComponent2 = _interopRequireDefault(_cyComponent);

	var _cyComponentReducer = __webpack_require__(18);

	var _cyComponentReducer2 = _interopRequireDefault(_cyComponentReducer);
	...
	function mapStateToProps(state) {
	  return {
	    name: state.cyComponentReducer.get('name')
	  };
	}
	...
	function mapDispatchToProps(dispatch) {
	  return {
	    changeName: function changeName(name) {
	      return dispatch((0, _cyComponentReducer.changeName)(name));
	    }
	  };
	}

	var component = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_cyComponent2.default);

	var reducers = { cyComponentReducer: _cyComponentReducer2.default };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CyComponent = function (_React$Component) {
	  ...
	  function CyComponent(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(CyComponent).call(this, props));
	  }
